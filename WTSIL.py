...
mode = "&mode=transit"
actual_arrival_time = 1487183626 #this value will change over time depending on when the program is run and stuff. Server side thing
...
#sends text message
msg = "The weather in " +str(config.city)+ " is " + str(int(temp)-273) + " with " + str(desc) + ". You should leave at " + str(leaveAt) + " and it will take "+str(travelTime)+" to get school."#
